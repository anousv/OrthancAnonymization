...
public class TableDataAnonPatients extends AbstractTableModel{
	 ...
	 */
	public void addPatient(String patientName, String patientID, Date birthdate, ArrayList<String> selectedStudies) throws IOException, ParseException{
		QueryFillStore queryID = new QueryFillStore("Patients", patientName, null, null, null);
		String[] id = queryID.extractData("id").split("SEPARATOR");
		Patient p = new Patient(patientName, patientID, id[0], birthdate, selectedStudies);
