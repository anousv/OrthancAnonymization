...
public class AboutBoxFrame extends JFrame{
	...
	public AboutBoxFrame(){
		...
		JLabel title = new JLabel("Dicom anonymizer v.1.0.0");
		...
		gbc.gridx = 0;
		gbc.gridy = 0;
		Image logoICR = new ImageIcon(ClassLoader.getSystemResource("claudiusregaud.png")).getImage();
		logosPanel.add(new JLabel(new ImageIcon(logoICR)), gbc);
		
		gbc.gridx = 1;
		gbc.gridy = 0;
		Image logoCHU = new ImageIcon(ClassLoader.getSystemResource("chu.png")).getImage();
		logosPanel.add(new JLabel(new ImageIcon(logoCHU)), gbc);
		
		gbc.gridx = 2;
		gbc.gridy = 0;
		Image logoIUT = new ImageIcon(ClassLoader.getSystemResource("iut.png")).getImage();
